...
RUN apt-get update \
  && apt-get upgrade -y \
  && apt-get install -y php-mdb2 libcurl4-gnutls-dev libpng-dev libssl-dev libc-client2007e-dev libkrb5-dev unzip cron re2c python tree libjpeg-dev libpng-dev wget \
